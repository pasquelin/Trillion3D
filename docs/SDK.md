...
light (`GraphMesh`, and the camera and light classes the engine builds), which add a `kind`, a
creation number and the reference's copy. The former aliases of the node, `HostNode`,
