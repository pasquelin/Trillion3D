...
never waits as long as a server asks, or by the reader's own retry, without that wait: the page
streamer's three attempts, the GPU page cache's two, a physics tile's next update. Another 4xx is
