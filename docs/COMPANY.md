...
| CTO                  | `/t3d-cto`              | boss       | keeps the pinned **Priorities** issue, starts and supervises the agents, decides technique, opens issues, reports in five lines, winds down at 80 % of plan usage | writes code, measures     |
