...
words, a change flag per word and the eviction bitset, 20.5 MiB (`SHADOW_HOST_BYTES`) — is the
CPU total's first share, before the decoded-page cache (`splitMemoryBudget`).
