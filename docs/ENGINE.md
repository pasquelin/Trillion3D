...
the pinned root cover. A page whose dependency has no bytes yet, or does not fit, is not loaded; it
stays drawn through its resident ancestor. Both tiers of the residency queue share this one path.
