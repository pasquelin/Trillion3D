...
import { EngineExample } from './engine-scene/index.jsx';
import { GeometryPreview } from './gallery/index.jsx';
...
import { Inline, Prose, Table } from './components/Prose.jsx';

function LiveDemo({ demo, locale }) {
  return (
...
function Example({ entry, locale, demo }) {
...
export function Entry({ entry, locale = 'en' }) {
