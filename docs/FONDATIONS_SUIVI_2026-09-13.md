...
| --- | --- | --- | --- |
| 1. Import glTF, QEM, identité des caches JS et Rust | Aucune | Partiel, commit à finaliser | Entrées invalides rejetées avant publication ; faces orientées ; changement de clé si l'algorithme change ; tests JS/Rust |
...
| 5. Hi-Z et rasterisation hybride | 4 | À faire | Occlusion/révélation, routage et pixels/profondeur/ID comparés sur matériel |
