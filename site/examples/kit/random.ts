 ...
 * seed gives the same scene on every run and every machine, integer arithmetic alone. Plenty for
 * placing pebbles, clouds and traffic, never for anything that must be unpredictable.
 */
