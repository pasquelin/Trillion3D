...
.trillion3d-menu { position: absolute; inset: 0; display: grid; place-items: center; padding: 16px;
...
.trillion3d-menu[hidden] { display: none; }
.trillion3d-card { box-sizing: border-box; width: min(100%, 420px); max-height: calc(100vh - 32px);
...
.trillion3d-caps small { flex-basis: 100%; text-align: end; opacity: 0.6; font-size: 11px; }
kbd.trillion3d-cap { min-width: 26px; padding: 3px 7px; border-radius: 6px; text-align: center;
