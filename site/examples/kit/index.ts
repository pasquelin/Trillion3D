 ...
 * names the error an example stops on; the line of what to do and the news it gives go to the
 * banner of the page hosting it (`banner.ts`). Its words, and the page's own, are read in
