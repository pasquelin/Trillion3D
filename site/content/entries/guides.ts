...
// In your page/component teardown: world.dispose();`,
  },
  {
    ...
    html: `<p>The mission, in <a class="link link-primary" href="https://github.com/pasquelin/WebGeometry/blob/develop/docs/PRODUCT_PRINCIPLES.md">Product principles</a>: virtualized geometry for the web at the performance of the best desktop engines — geometry streamed by clusters, one cut through a DAG per frame, a visibility buffer, temporal antialiasing, fixed streaming and memory budgets. The lighting is what the geometry is for; its stages are in <code>docs/LIGHTING_STRATEGY.md</code>.</p>
...
<p>The flat-array batch kernels a host driving thousands of objects by hand might reach for (<code>batch.multiplyMatrix4</code>, <code>batch.transformPoints</code>, …) are a public family, exported by <code>web-geometry</code> like any other: they are catalogued batch by batch in <a class="link link-primary" href="https://github.com/pasquelin/WebGeometry/blob/develop/docs/API.md">docs/API.md</a>.</p>`,
  },
  {
    ...GUIDE,
