...
<li><code>panZoomControls()</code> — <strong>planar pan-zoom</strong>: the camera never turns; drags slide the view, wheel and pinch move it in and out of the plane it faces, and the arrow keys pan it by a fixed step for a viewer who has no pointer.</li>
</ul>
