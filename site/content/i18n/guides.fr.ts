...
<li><code>panZoomControls()</code> — le <strong>pan-zoom plan</strong> : la caméra ne tourne jamais ; les glissers font glisser la vue, molette, pincement et flèches l’éloignent ou la rapprochent du plan qu’elle regarde.</li>
</ul>
