...
<tr><td><code>THREE.LOD</code> / <code>THREE.InstancedMesh</code> / <code>THREE.BatchedMesh</code></td><td>rien : la coupe du DAG, une par image, est ce que ces classes existent pour approcher (délibérément absentes, <a class="link link-primary" href="https://github.com/pasquelin/WebGeometry/issues/319">issue #319</a>)</td></tr>
</tbody></table></div>
