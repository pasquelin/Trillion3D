      ...
      >
        {renaming ? (
          <input
            ...
            aria-label={t(locale, 'editor.rename')}
        ...
        <Button
          ...
          aria-label={t(locale, node.visible ? 'editor.hide' : 'editor.show')}
          title={t(locale, node.visible ? 'editor.hide' : 'editor.show')}
    ...
    >
      ...
      {roots.length === 0 ? (
        ...
        <>
          ...
          <Note>{t(locale, 'editor.dropRoot')}</Note>
        </>
      )}
    </nav>
  );
