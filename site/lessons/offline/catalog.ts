...
export const offlineExamples = geometryRecipes.map((recipe) => {
  ...
  return {
    ...
    constructionCode: [
      "import { box, combine, mapPositions } from './site/lessons/offline/mesh.ts';",
      "import { terrain, loft, rationalPatch, sculpture, splineTube, vessel, city } from './site/lessons/offline/surfaces.ts';",
