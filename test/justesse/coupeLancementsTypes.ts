// Result shape of the dispatch-count measurement (`coupeLancementsPage.ts`), read by the bench
// (`coupe-lancements-gpu.ts`). Split apart so both files hold `check:lines`.
