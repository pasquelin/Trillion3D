...
// `test/justesse/noyauSelectionGpu.ts`.
//
// node --experimental-strip-types test/browser/cone-echelle-non-uniforme.browser.ts
...
import { selectionGpu } from '../justesse/noyauSelectionGpu.ts';
 ...
 *  identical to `test/justesse/cone-echelle-non-uniforme.ts`. */
...
console.log(
  'OK: 2 cases, 4 runs of the WGSL kernel — see test/browser/cone-echelle-non-uniforme.browser.ts',
);
