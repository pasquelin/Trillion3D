...
//
// The page (`test/appui/transparentTransformPage.ts`) is bundled by esbuild and run in Chromium
// with a real WebGPU device. Nothing is simulated: `webgpuPagesBackend`, its passes and its image readout.
//
//   node --experimental-strip-types test/browser/transparent-transform.browser.ts
