...
//
//   node --experimental-strip-types test/browser/image-tenue-couleur.browser.ts
import assert from 'node:assert/strict';
import { preuveDansLaPage, type ResultatPagePreuve } from '../appui/preuvePageMoteur.ts';
