...
//
// node --experimental-strip-types test/browser/cisaillement-transform.browser.ts
...
console.log(
  'OK: 2 matrices, 2 views, 4 runs of the WGSL kernel — see test/browser/cisaillement-transform.browser.ts',
);
