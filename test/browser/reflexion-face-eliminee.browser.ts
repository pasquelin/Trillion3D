...
//
// node --experimental-strip-types test/browser/reflexion-face-eliminee.browser.ts
...
import { tousLesCas } from '../justesse/inverseTransposeEchantillon.ts';
import { chargeRaster, pageVisible, VUE } from '../justesse/reflexionCas.ts';
import { rasterGpu } from '../justesse/noyauRasterGpu.ts';
...
console.log(
  'OK: 6 916 cases rasterised on a real GPU — see test/browser/reflexion-face-eliminee.browser.ts',
);
