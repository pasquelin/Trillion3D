...
// `adressageGpuPage.ts` (test/justesse) holds the WebGPU orchestration and the tap shader,
...
import {
  ...
  surCouture,
  TOLERANCE,
} from '../justesse/adressageCas.ts';
import { executerDansChromium, MELANGE, NUANCEUR_PRISES } from '../justesse/adressageGpuPage.ts';
