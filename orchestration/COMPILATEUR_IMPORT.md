...
Faits : TGA, Unity (scène, prefabs, sous-maillages, échelle, retouches), ZIP, `.unitypackage`, TIFF, DDS, WebP sans perte, EXR/HDR, KTX2, USD/USDZ.
...
3. `.blend` (USD, USDZ et Alembic sont faits).
