...
- Machine : MacBook Pro M2 Max, écran 120 Hz ProMotion, Chrome stable. Chrome headless plafonne vers 59,9 Hz quels que soient les drapeaux GPU (54,6 Hz avec `--disable-frame-rate-limit`, retiré des `BASE_FLAGS`) : seul le mode visible (`HEADLESS=0`, `scripts/headless/README.md`) atteint le rafraîchissement réel de l'écran (120 Hz).
