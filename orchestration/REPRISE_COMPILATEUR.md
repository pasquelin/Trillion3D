...
2. À la livraison de la vague 5 : preuve au Validateur, puis suppression des trois worktrees et branches. Tous les formats de la politique sont alors « fait ». Décision de l'utilisateur (15 sept. 2026, 20 h) : après cela, **un seul Opus à la fois**, un complément par lot, dans l'ordre : `compilateur/mtl` (dorée obj, MTL absent/tronqué en rapport nommé, Ks/Ni/Ka comptés, garde bump/norm, options de map comptées), puis les compléments du point 3.
