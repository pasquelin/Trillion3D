...
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| A cache et MTL obj                              | 1, 2 + audit MTL — **livré 46d0d61** (obj/fbx `-gltf-5`, 9 codes, dorée obj) ; restes : `-o`/`-s` comptés, `-clamp` sans preuve navigateur, `encode_relative` câblé dans l'import ufbx seulement — `blend/images.rs:59-92`, `ma/texture.rs:60`, `usd/texture.rs:61`, `unity/textures.rs:54` écrivent encore l'URI brute (à faire au lot H ou J), `texture_ref` du simplify sans test | `import/runner.rs`, `import/textures.rs`, `import/materials.rs`, `src/uri.rs`  |
