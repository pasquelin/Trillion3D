...
- H routing/archives: **next**, 3,4,5,6,26 + raw texture URI in blend/ma/usd/unity (batch A leftover); `route.rs`, `unitypackage.rs`, `zip_reader.rs`, `usdz.rs`, `alembic/ogawa.rs`.
