...
Ordre proposé, prime sur l'ordre implicite de la section 8 : rebond 3 → transparents sans ambiance → ombres lointaines du soleil contre le proxy → reflet pour toute surface (LR7) → reflets flous → éclairage stochastique par pixel (RX2) → optimisation mesurée.
