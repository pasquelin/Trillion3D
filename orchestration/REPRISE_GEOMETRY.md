...
| 17 | Nettoyage des branches fusionnées (Validateur) | propreté | très faible |
...
17. **Nettoyage** : branches `lot/hote-delta`, `lot/selection-compacte`, `lot/compteurs-null`, `lot/raster-calcul`, `lot/fiches-et-trace`, `lot/hote-pages-incremental` fusionnées, worktrees à supprimer (Validateur).
