# Audit des pilotes du compilateur — 58 constats (15 sept. 2026, état f6ac76f)
...
Ordre retenu par l'utilisateur : fidélité des scènes et cache OBJ, puis plantages, puis les autres familles ; **un lot à la fois, un seul Opus** ; chaque lot = reproduction ciblée en test, correction générique, vérification du comportement, preuve visuelle si le rendu change. Les tests actuels laissent passer ces erreurs et certaines dorées figent un résultat faux : chaque lot corrige aussi la dorée.
