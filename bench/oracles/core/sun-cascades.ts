// Oracle for point G8: `packages/sdk-core/src/scene/light-shadow/sunCascades.ts` before batch G — bounds recomputed at each
...
/** `packages/sdk-core/src/scene/light-shadow/sunCascades.ts`: bounds were recomputed at each face for the same view. */
...
export function referenceSunCascadeOf(
