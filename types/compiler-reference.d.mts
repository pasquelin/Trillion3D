...
export interface CompileOptions {source:Store;cache:Store;hash:(bytes:Uint8Array)=>string;compilerHash?:string;resourceBaseUrl:string;scope?:'slice'|'full';budget?:number;signal?:AbortSignal;onProgress?:(event:{phase:string;completed:number;total:number;scope:'slice'|'full';key:string})=>void}
