...
- **visibilityShadingNormal.ts** (41 connections) — `packages/sdk-browser/visibilityShadingNormal.ts`
...
- **frameBitangents** (1 connections) — `packages/sdk-browser/visibilityShadingNormal.ts`
- **frameN** (1 connections) — `packages/sdk-browser/visibilityShadingNormal.ts`
- **frameNormals** (1 connections) — `packages/sdk-browser/visibilityShadingNormal.ts`
