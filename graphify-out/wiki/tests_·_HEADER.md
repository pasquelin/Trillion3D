...
- **tree()** (6 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **link_field()** (4 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **named()** (4 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **with_sharp_edges()** (4 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **with_stray_object()** (4 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **declared_field()** (3 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **put()** (3 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **socket()** (3 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **without_field()** (3 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **HEADER** (1 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
- **SPARE** (1 connections) — `packages/asset-compiler-rust/src/plugins/scene/blend/tests/surgery.rs`
