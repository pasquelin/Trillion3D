...
- **cheminBaseline()** (5 connections) — `packages/sdk-core/bench/socle/chemins.mjs`
- **baseline-save.mjs** (5 connections) — `scripts/mesure/perf/baseline-save.mjs`
- **chargeBaseline()** (4 connections) — `packages/sdk-core/bench/socle/baseline.mjs`
- **cleDeLigne()** (4 connections) — `packages/sdk-core/bench/socle/baseline.mjs`
- **compareBaseline()** (4 connections) — `packages/sdk-core/bench/socle/baseline.mjs`
- **cheminFragment()** (4 connections) — `packages/sdk-core/bench/socle/chemins.mjs`
- **confronteBaseline()** (4 connections) — `packages/sdk-core/bench/socle/rapport.mjs`
- **commitCourant()** (3 connections) — `packages/sdk-core/bench/socle/baseline.mjs`
...
- `packages/sdk-core/bench/socle/baseline.mjs`
- `packages/sdk-core/bench/socle/baseline.test.mjs`
- `packages/sdk-core/bench/socle/chemins.mjs`
- `packages/sdk-core/bench/socle/rapport.mjs`
- `packages/sdk-core/bench/socle/tableau.mjs`
- `scripts/mesure/perf/agrege.mjs`
- `scripts/mesure/perf/baseline-save.mjs`
