...
- **avantLeLot()** (7 connections) — `test/justesse/inverseTransposeF32.mjs`
- **unitaire()** (7 connections) — `test/justesse/inverseTransposeF32.mjs`
- **cofacteur()** (5 connections) — `test/justesse/inverseTransposeF32.mjs`
- **croix()** (5 connections) — `test/justesse/inverseTransposeF32.mjs`
