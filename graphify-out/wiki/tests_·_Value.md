...
- **encode_glb()** (5 connections) — `packages/asset-compiler-rust/src/tests/fixtures.rs`
- **glb()** (5 connections) — `packages/asset-compiler-rust/src/tests/unity_projet.rs`
- **.new()** (3 connections) — `packages/asset-compiler-rust/src/tests/unity_projet.rs`
- **compile_accepts_glb_without_manifest()** (2 connections) — `packages/asset-compiler-rust/src/tests/part4.rs`
- **Value** (1 connections)
