...
- **Fixture dorée — pilote PSD et PSB (composite aplati)** (13 connections) — `packages/asset-compiler-rust/fixtures/psd/README.md`
- **Fixture minimale** (13 connections) — `packages/asset-compiler-rust/fixtures/dds/README.md`
- **Fixture dorée — pilote Radiance HDR (RGBE)** (12 connections) — `packages/asset-compiler-rust/fixtures/hdr/README.md`
- **Fixture dorée — pilote PNG** (12 connections) — `packages/asset-compiler-rust/fixtures/png/README.md`
- **Fixture dorée — pilote OpenEXR** (11 connections) — `packages/asset-compiler-rust/fixtures/exr/README.md`
- **Fixtures écrites octet par octet depuis la spécification publique** (11 connections) — `packages/asset-compiler-rust/fixtures/bmp/README.md`
- **Politique de fidélité — refuser plutôt que perdre** (9 connections) — `packages/asset-compiler-rust/fixtures/gif/README.md`
- **Référence écrite en clair dans le test** (9 connections) — `packages/asset-compiler-rust/fixtures/bmp/README.md`
- **expected.json — l'attendu sans horloge ni clé de cache** (8 connections) — `packages/asset-compiler-rust/fixtures/obj/README.md`
- **Fixture dorée — pilote DDS** (7 connections) — `packages/asset-compiler-rust/fixtures/dds/README.md`
- **Double lecture par un décodeur indépendant** (7 connections) — `packages/asset-compiler-rust/fixtures/bmp/README.md`
- **La même image écrite de plusieurs façons** (7 connections) — `packages/asset-compiler-rust/fixtures/hdr/README.md`
...
- `packages/asset-compiler-rust/fixtures/dds/README.md`
- `packages/asset-compiler-rust/fixtures/exr/README.md`
- `packages/asset-compiler-rust/fixtures/gif/README.md`
- `packages/asset-compiler-rust/fixtures/hdr/README.md`
