...
- **Value** (3 connections)
- **offset_quantum()** (2 connections) — `packages/asset-compiler-rust/src/coplanar.rs`
- **COPLANAR_MAX_LAYER** (1 connections) — `packages/asset-compiler-rust/src/coplanar.rs`
- **COPLANAR_STAGE** (1 connections) — `packages/asset-compiler-rust/src/coplanar.rs`
...
- **unsplit_material** (1 connections)
