...
- **sdk-browser/package.json** (9 connections) — `packages/sdk-browser/package.json`
- **engines** (2 connections) — `packages/sdk-browser/package.json`
- **peerDependencies** (2 connections) — `packages/sdk-browser/package.json`
