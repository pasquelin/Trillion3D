...
// and `tests/integration/structure-moteur.test.ts`; the loading computation boundary, in
...
export const DECLARATION: Record<string, string> = {
  ...
  'bench/perf/browser/support/scenesCoupe':
    'bench mount: it pairs a host material with the record of it',
  'bench/perf/browser/backend-autonome.perf':
    'bench: its pages carry the declaration the witness repaints with',
  'bench/perf/browser/cadre-vue.perf': 'bench: the page records it builds carry the field',
  'bench/perf/browser/coupe-difference.perf': 'bench: the page records it builds carry the field',
  'bench/perf/browser/lignes-dessinables.perf': 'bench: the page records it builds carry the field',
  'bench/oracles/browser/collecte-pages':
