...
// (`packages/sdk-browser/src/gpu/dag/resources.ts`, `packages/sdk-browser/src/gpu/dag/dispatch.ts`). The useful cut, however, is only a few tens
...
import type { executer, Ligne } from './cutSnapshotPage.ts';
