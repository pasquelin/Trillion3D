...
//     tests/browser/probes/adressage-gpu.ts [sortie.json]
...
// The marks `adressageCas.ts` writes on a key, and the only ones: a gap at a boundary or on a
