// Defect 6: in `inverseTranspose3` (packages/sdk-browser/src/gpu/dag/shader/shader.ts), the `abs(det)<1e-20` guard returned the
...
// the fixed version as shipped, and the PREVIOUS version rebuilt by `substitutionBefore.ts`,
...
import { DETERMINISTES, HORS_BANDE, SCALES, tousLesCas } from './inverseTransposeSample.ts';
