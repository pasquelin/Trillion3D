...
//
//   node --experimental-strip-types tests/browser/renders/partition-gpu-conservatrice.browser.ts
...
const audit = await empaquetePage(
  join(ROOT, 'tests/browser/support/partitionConservatricePage.ts'),
  undefined,
  {
    format: 'esm',
  },
