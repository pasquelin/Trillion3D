...
//
//   node --experimental-strip-types tests/browser/renders/image-tenue-couleur.browser.ts
import assert from 'node:assert/strict';
import { preuveDansLaPage, type ResultatPagePreuve } from '../support/preuvePageMoteur.ts';
