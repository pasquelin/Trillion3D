...
// `adressageGpuPage.ts` (tests/browser/probes) holds the WebGPU orchestration and the tap shader,
...
import {
  ...
  surCouture,
  TOLERANCE,
} from '../probes/adressageCas.ts';
import { executerDansChromium, MELANGE, NUANCEUR_PRISES } from '../probes/adressageGpuPage.ts';
