 ...
 *  identical to `tests/browser/probes/cone-echelle-non-uniforme.ts`. */
...
console.log(
  'OK: 2 cases, 4 runs of the WGSL kernel — see tests/browser/renders/cone-echelle-non-uniforme.browser.ts',
);
