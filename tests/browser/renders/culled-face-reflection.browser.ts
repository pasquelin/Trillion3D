...
//
// node --experimental-strip-types tests/browser/renders/culled-face-reflection.browser.ts
...
console.log(
  'OK: 6 916 cases rasterised on a real GPU — see tests/browser/renders/culled-face-reflection.browser.ts',
);
