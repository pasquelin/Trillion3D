...
//
// node --experimental-strip-types tests/browser/renders/normale-eclairage-petite-echelle.browser.ts
import assert from 'node:assert/strict';
import { construireCas, ecart } from '../probes/normaleEclairageCas.ts';
...
console.log(
  `OK: ${lignes.length} cases, one run of the lighting texts — see` +
    ' tests/browser/renders/normale-eclairage-petite-echelle.browser.ts',
);
