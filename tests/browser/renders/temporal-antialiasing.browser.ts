...
//
//   node --experimental-strip-types tests/browser/renders/temporal-antialiasing.browser.ts
...
import { estRouge } from '../support/sceneImageProof.ts';
import { auBord, ecarts } from '../support/antialiasingDiffs.ts';
