...
// protect nothing in `tests/browser/renders/normal-transform-arithmetique.browser.ts` — that is
...
//
// node --experimental-strip-types tests/browser/renders/normale-eclairage-substitutions-refusees.browser.ts
...
import {
  ...
  EFFONDREES,
  REGULIERE_MINUSCULE,
} from '../probes/normalTransformCas.ts';
import { SUBSTITUTIONS, eclairageGpu } from '../probes/normaleEclairageGpu.ts';
