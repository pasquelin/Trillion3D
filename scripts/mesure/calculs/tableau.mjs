// Partie commune aux trois agrégateurs : racine du dépôt, lecture des fragments déposés par les
// bancs et écriture du couple Markdown / JSON. Les bancs et leurs oracles vivent dans le paquet
// mesuré (`packages/*/bench/`) ; ce dossier n'importe rien d'un paquet, il ne lit que leurs
// fragments.
