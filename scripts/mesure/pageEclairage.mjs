...
export async function measureView(options) {
  ...
  // other, itself places in Three the lights that store declares (`pageTemoin.mjs`).
  ...
  // The capture is that of a HELD pose (`pageMesure.mjs`): `imagesCalme` says how many frames
