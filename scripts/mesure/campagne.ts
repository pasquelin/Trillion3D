...
//
//   node scripts/mesure/campagne.ts [--out .mesure/out/global] [--scene a,b] [--seulement name,name] [--liste]
//
// Each line names what it isolates: a single option distinguishes it from its neighbor, and it is
// this difference that is read in `rapportGlobal.ts`. Resolutions, camera, sun, and baked textures
