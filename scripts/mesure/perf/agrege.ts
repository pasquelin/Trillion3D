...
// under `.mesure/out/perf/`. Regression thresholds come from `bench/socle/baseline.ts` and
// the rendering of a line from `bench/socle/tableau.ts`: a line and the conclusion of the
// same table cannot contradict each other, and a bench console shows the same format as the aggregate.
import { mkdirSync, writeFileSync } from 'node:fs';
import { loadavg } from 'node:os';
import { join } from 'node:path';
import { commitCourant, compareBaseline } from '../../../packages/sdk-core/bench/socle/baseline.ts';
import type { LigneAvecEcartBaseline } from '../../../packages/sdk-core/bench/socle/baseline.ts';
import { RACINE } from '../../../packages/sdk-core/bench/socle/chemins.ts';
import { lisFragments } from '../../../packages/sdk-core/bench/socle/rapport.ts';
import { entete, ligneMd } from '../../../packages/sdk-core/bench/socle/tableau.ts';
