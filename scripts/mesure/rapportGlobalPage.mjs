...
main{margin:0;padding:24px 24px 64px}h1{font-size:28px;margin:0 0 4px}h2{font-size:21px;margin:40px 0 8px;padding-top:16px;border-top:1px solid var(--grille)}h3{font-size:16px;margin:20px 0 6px}
...
@media (max-width:1100px){.fiches{grid-template-columns:1fr}.deux-cols{grid-template-columns:1fr}}
