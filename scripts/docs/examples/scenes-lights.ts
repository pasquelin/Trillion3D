...
import type { PartsScene } from './workshop.ts';
...
function lighthouse(): PartsScene {
  const shop = workshop(),
    next = random(11);
  slab(shop, 0, 30, 0.4);
  shop.lathe(
