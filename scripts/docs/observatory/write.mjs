...
import { createObservatory, observatoryMaterials } from './scene.mjs';

/** Serialize authored surfaces as separate material primitives, with no external resources. */
export async function writeObservatory(directory) {
  const gltf = {
    asset: {
      version: '2.0',
      generator: 'Web Geometry Solstice Court recipe v1',
  ...
  const chunks = [];
  function attribute(values, size, index = false) {
