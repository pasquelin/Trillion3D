...
export function createWorkshop() {
  ...
  function patch(material, columns, rows, point) {
    if (!surfaces.has(material))
      surfaces.set(material, { positions: [], normals: [], indices: [] });
    const mesh = surfaces.get(material),
  ...
  function block(material, center, size) {
  ...
  function turned(material, center, radius, height, flutes = 0, segments = 64) {
  ...
  function ring(material, center, radius, tube, tilt = 0, sweep = Math.PI * 2) {
