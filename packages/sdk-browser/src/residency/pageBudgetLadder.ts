 ...
 * cut admission (`../webgpu/pages/render/gpuCutAdmission.ts`) and the WebGL2 pool
...
/** The verdict change both engines publish as `coverage-budget`: the cut that asked for
 *  `requiredSlots` against `slots`, sampled at `pixelError`. */
