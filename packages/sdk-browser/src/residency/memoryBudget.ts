 ...
 *   the other fixed shadow buffers; the rest in two halves, the geometry pool and the texture
 *   pool, each no larger than its ceiling. The shadows never shrink: a total under the shadow pool
