...
import { DRAW_INDIRECT_STRIDE } from '../draw/contract.ts';
...
export const SHADOW_FACE_STRIDE = 256;
...
const FLAG_GPU_BYTES = MAX_SHADOW_BATCHES * 4,
  FLAG_HOST_BYTES = MAX_SHADOW_BATCHES * MAX_SHADOW_PAGES * 5 + MAX_SHADOW_BATCHES * 2;
