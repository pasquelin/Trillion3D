 ...
 * (`../partition/uniform.ts`) and the transparent occlusion test reads the SAME buffer. Two boxes
 ...
 * share of input rounding (`../partition/margins.ts` carries both proofs). Corners enter RELATIVE
