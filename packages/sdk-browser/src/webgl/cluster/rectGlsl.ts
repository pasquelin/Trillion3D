 ...
 * as on the WebGPU path: the contract refuses one for a rectangle. A diffuse or toon surface takes
 * the rectangle's light through `modelLight` (`../../scene/surfaceModel.ts`), as that path does.
 *
