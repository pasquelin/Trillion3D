...
/** Puts `entry` where its node stands now; false when nothing moved. A node the page destroyed
 *  is let go: its guide stays where it last stood, and the frame goes on. */
