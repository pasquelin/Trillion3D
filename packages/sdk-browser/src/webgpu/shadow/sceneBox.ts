 ...
 * casts no shadow, and its box would only spread the range. A mesh set to cast none stays in, as
 * it was before it could say so: the range is the same whichever meshes cast. Rebuilt only when a pose moved
