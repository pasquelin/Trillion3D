/**
 * The eviction order the host-memory pools share — the page streamer's cache, the decoded texture
 * levels and the WebGL2 geometry pool: entries leave oldest first, in the insertion order of the `Map` or `Set` that
