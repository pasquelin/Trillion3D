 ...
 * their own — the view revision of the engines rendered by Three (`frameViewRevision.ts`) and the
 * hold of the Hi-Z screen rectangles (`hizProjectionHold.ts`) — with two `Float64Array(16)` and
