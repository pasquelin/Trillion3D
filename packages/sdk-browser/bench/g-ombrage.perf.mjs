// G3 : l'ombrage par pixel du visbuffer CPU.
...
const resOmbrage = await mesure({
  nom: 'G3 ombrage par pixel du visbuffer',
...
rapport('g-ombrage', [resOmbrage], 'G3 rend les mêmes trois canaux, au bit près, sur chaque pixel');
