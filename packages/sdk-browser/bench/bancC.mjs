...
import { RACINE, mediane as chronometre } from '../../sdk-core/bench/banc.mjs';
...
/** Une ligne pour la console pendant la course ; l'en-tête et le tableau final sont à `agrege-c.mjs`. */
function ligneMarkdownC(l) {
