...
//
// Each site of `tests/browser/probes/cameraSites.ts` — selection uniforms, cut, Hi-Z, rasters,
...
import { SITES, residuRepereDeRendu } from '../../tests/browser/probes/cameraSites.ts';
