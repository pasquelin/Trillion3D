...
// Oracle : la version sans cache, d'avant le lot A, dans `scripts/mesure/calculs/oracles/pages.mjs`.
import test from 'node:test';
import assert from 'node:assert/strict';
import * as THREE from 'three';
import { setWindingEpoch, windingCw } from './webgpuPagesWinding.ts';
import { referenceWindingCw } from '../../scripts/mesure/calculs/oracles/pages.mjs';
