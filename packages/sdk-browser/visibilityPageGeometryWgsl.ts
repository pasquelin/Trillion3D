...
import { FLAG_CLUSTER_PAGE } from './visibilityTypes.ts';
import { PAGE_UV_WGSL, PAGE_VERTEX_WGSL } from './visibilityPageWgsl.ts';
 ...
 * `clusterDecodeWgsl.ts`: nothing of that cluster is ever uploaded as floats. A primitive the
 ...
 * three floats on the source buffer. Declared after `vertN` (`visibilityShaderShadeDecl.ts`),
