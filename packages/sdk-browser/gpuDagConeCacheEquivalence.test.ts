...
// D5: gpuDagShader.ts now computes coneRejects once per visible page (dagWanted) and
// rereads it in dagEscalate/dagCheck/dagMask instead of recomputing. evaluateDagSelectionKernel
// carries both modes behind its 4th parameter `cacheCone` (gpuDagOracle.ts): false recomputes
