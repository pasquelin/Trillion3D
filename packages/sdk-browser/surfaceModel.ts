 ...
 *
 * The engine lights every surface with one model (`standardLighting.ts`). A host material of
 ...
 * away (`depthConvention.ts`) —, the light-to-dark ramp a depth material shows.
 */
