 ...
 *
 * Deux files en bascule, pas de tampon neuf : le plafond de huit tampons de stockage par étape est
 * atteint depuis longtemps. La file 0 occupe la plage que les drapeaux de nœuds occupaient, la file 1
 * suit les candidates, et les compteurs prolongent `work` derrière ceux de la liste vivante.
 *
 ...
 */
export const DAG_LEVEL_WGSL = `fn queueBase(q:u32)->u32{return select(0u,uni.nodeCount+uni.clusterCount*4u,q==1u);}
