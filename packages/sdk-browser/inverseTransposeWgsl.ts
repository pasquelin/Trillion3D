 ...
 * (`gpuDagShader.ts`, cone axis) and the lighting-normal transform (`standardLighting.ts`,
 ...
 *  4. Non-finite transform: refused at the engine entry (`hostWorldMatrices.ts`,
 *     `explorerScene.ts`, `webgpuPagesTransform.ts`), never silently replaced here.
 *
 ...
 * block, structure included, and `test/justesse/substitutionAvant.mjs` establishes the
 ...
 * where the shipped form drops none (`test/justesse/inverse-transposee-petite-echelle.mjs`).
