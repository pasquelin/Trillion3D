...
// the first. The reference rule is `lineaireThree` (test/justesse/adressageCas.mjs), written
// independently of `wrapLinear` and already checked against the real WebGL2 and WebGPU samplers
// by `test/justesse/adressage-gpu.mjs`: the low rank comes from the coordinate shifted by a
