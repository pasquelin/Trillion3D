...
| PSD / PSB               | spécification publiée par Adobe pour les lecteurs tiers | en cours, vague 5 | aplati seulement, vers RGBA8               | P3       |
...
| Maya ASCII `.ma`                           | format documenté ; données seulement, aucun script exécuté                                     | en cours, vague 5 | sous-ensemble nœuds, attributs, connexions                                      | P3                  |
