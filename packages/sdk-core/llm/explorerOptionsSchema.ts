...
export const EXPLORER_OPTIONS_SCHEMA: JsonSchemaObject = {
  type: 'object',
  description:
    'Initialization options for the WebGeometry rendering engine (openMeasuredWorld). Configures virtualized geometry (Nanite), temporal antialiasing (TAA), fixed GPU memory pools, dynamic lighting (Lumen), and virtual shadow maps.',
  properties: {
    interactive: {
      type: 'boolean',
      default: false,
