...
export const LOD_QUALITY = {
 source:{id:'source',label:'Détail source maximal',pixelError:0,anisotropy:'source',adaptive:false},
 high:{id:'high',label:'Qualité élevée',pixelError:1,anisotropy:'maximum',adaptive:false},
 balanced:{id:'balanced',label:'Qualité équilibrée',pixelError:4,anisotropy:'source',adaptive:false},
 adaptive:{id:'adaptive',label:'Mode adaptatif',pixelError:2,anisotropy:'source',adaptive:true},
} as const;
