...
export const rects = new Float64Array(VIEWS * 4);
/** Face matrices of the lamp being invalidated and their depth spans; the box's light-plane or
 *  face rectangle; the box clipped to a point face's depth span. All allocated once. */
...
export function lampFaces(light: SceneLight, faces: number) {
