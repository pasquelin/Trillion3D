...
export const LIGHT_SETTINGS = {
   ...
   * both depths. The receiver's slope is covered by a depth margin over the PCF's reach, in the
   * same texels (`shadowReceiverBias`): no bias is a length of the scene.
   */
