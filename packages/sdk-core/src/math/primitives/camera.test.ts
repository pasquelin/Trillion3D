// Batch 3, camera.ts: perspective projection in REVERSED depth and infinite far plane
...
import { createCameraFrame, perspectiveProjection, updateCameraFrame } from './camera.ts';
