...
export const DIAGNOSTICS:DiagnosticCapabilities={
 ...
 lod:{available:true,reason:'Exact leaves vs coarse QEM pages actually selected this frame'},'screen-error':{available:true,reason:'Projected error used for the cut when errorObject exists; otherwise no color scale'},
