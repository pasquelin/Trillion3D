...
import type { Patch, Scene, Vec3 } from '../lightingExperimentScene.ts';
import { graine, mesure, stress, rapport } from './socle.ts';
import type { MesureCas } from './socle.ts';
import { referenceLength, referenceValidateScene } from './oracles/vecteurs-transport.ts';
