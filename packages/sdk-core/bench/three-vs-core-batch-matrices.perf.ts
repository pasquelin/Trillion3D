...
import { rapport } from './socle.ts';
import type { Mesure } from './socle.ts';
import { duel, points, quaternion } from './oracles/three-duel.ts';
import { N, prepareBatchData } from './oracles/batch-duel.ts';
