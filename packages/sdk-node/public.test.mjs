...
import {prepare,createCompilationJob,DEFAULT_SCOPE,COMPILER_OUTPUT_LIMIT,getSdkProvenance} from './index.mjs';
test('Node SDK public API imports without executing a compiler or depending on UI',()=>{assert.equal(typeof prepare,'function');assert.equal(typeof createCompilationJob,'function');assert.equal(typeof getSdkProvenance,'function');});
